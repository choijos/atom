...
module.exports = class AbstractPackage {
  constructor(params) {
    if (this.constructor === AbstractPackage) {
      throw new Error("Abstract package cannot be directly instantiated");
    }
  ...
  getType() {
    throw new Error('Method getType() needs to be implemented in derivative classes');
    
  }; 

  getStyleSheetPriority() {
    throw new Error('Method getStyleSheetPriority() needs to be implemented in derivative classes');

  };

  enable() {
    throw new Error('Method enable() needs to be implemented in derivative classes');

  };

  disable() {
    throw new Error('Method disable() needs to be implemented in derivative classes');

  };

  preload() {
    throw new Error('Method preload() needs to be implemented in derivative classes');
  };

  finishloading() {
    throw new Error('Method finishloading() needs to be implemented in derivative classes');

  };

  load() {
    throw new Error('Method load() needs to be implemented in derivative classes');
